function [EXT, TEMP_EXT, ext0] = bf_ext(mech, P_in, T_in, COMP,index, X0, destination_out, n_start, n_end)
    ...
    dlmwrite( destination_out, [EXT, TEMP_EXT, TEMP_init],'precision','%.20f' );
